...
# Admin panel token — required to access /admin routes (keep secret!)
# Generated by install.sh via: openssl rand -hex 24
ADMIN_TOKEN=${ADMIN_TOKEN}
# Super admin Steam ID — this Steam account gets automatic admin access
# Format: STEAM_0:0:XXXXXXXX or STEAM_0:1:XXXXXXXX (your Steam2 "Legacy" ID)
# Find yours at: https://steamid.io (enter your Steam profile URL, copy "SteamID")
# Leave empty to skip — you can add admins manually via the mm_admins table.
